...
public class NumberPalindrome {
    public static void main(String[] args) {
        System.out.println("Is it a Palindrome number? " + isPalindrome(-707));
        System.out.println("Is it a Palindrome number? " + isPalindrome(-345));
    ...
    public static boolean isPalindrome(int number) {
        int reverse = 0;
        int n = Math.abs(number); // original Abs Number
        System.out.println("originalAbsNumber= " + n);
        while (n != 0) {
            int lastDigit = n % 10;
