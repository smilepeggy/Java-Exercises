...
public class Point {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("distance(second)= " + first.distance(second)); // 5.0 // (3,1)-(6,5)
        System.out.println();
        System.out.println("distance(2,2)= " + first.distance(2, 2)); // 5.0 // (2,2)-(6,5)
        System.out.println();
        Point point = new Point();
        System.out.println("distance()= " + point.distance()); // 0
    }
    ...
    public double distance() {
        System.out.println("(xA,yA) = " + '(' + this.x + ',' + this.y + ')');
